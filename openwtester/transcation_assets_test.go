...
func TestTransfer_IF(t *testing.T) {

	addrs := []string{
		"0x42fc9217eadbabc4fc3c19e972286c4075f36aa4",
		"0x544b3615c15c015a582fbf64056102ca3af99326",
		"0x6a6db7299f724102be10b1a3def071fd529e121b",
		"0xcae30e7b124a9ec4d94015c03cfbe8d9e73b2bb3",
		"0xf22af20232ab6dba476023c80e6bb2ea700b7337",
		"0xfdafbad97927db83a31c245bb765393d21e3f7c2",
	}
...
func TestTransfer_ERC20(t *testing.T) {
	...
	addrs := []string{
		"0x0cfbca31feea5d426983649c0de6db8f6d982f14",
	}

	tm := testInitWalletManager()
	walletID := "VzaDZoSwtU71nfyzMTSSj84cQjgMWmFNpv"
	accountID := "J9f6vM9GC7AgUH5ucBpbk684kVtsU8Ehxi6JSnfi9bcR"
...
func TestSummary_IF(t *testing.T) {
	tm := testInitWalletManager()
	walletID := "W4Fyh8Voz6R1iGf5bugscqUyYSsNMVoHh7"
	accountID := "6Ghx53tZVgjcfrSgFmi8tcwE3R9NqHuYn7Cn6iyiV1F2"
	summaryAddress := "0xbf0c58e0fe5b8837d8ccc0997d8fb71872fc0272"
