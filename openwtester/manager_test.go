...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO IF", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W4Fyh8Voz6R1iGf5bugscqUyYSsNMVoHh7")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "W4Fyh8Voz6R1iGf5bugscqUyYSsNMVoHh7"
	account := &openwallet.AssetsAccount{Alias: "IF", WalletID: walletID, Required: 1, Symbol: "IF", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "W4Fyh8Voz6R1iGf5bugscqUyYSsNMVoHh7"
	accountID := "6Ghx53tZVgjcfrSgFmi8tcwE3R9NqHuYn7Cn6iyiV1F2"
	//accountID := "CxRfMAt2gwUiCxZy823H4apWKaHR3UfgtiDcXg2DDJPV"
