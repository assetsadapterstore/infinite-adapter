...
func testNewWalletManager() *WalletManager {
	...
	//读取配置
	absFile := filepath.Join("conf", "IF.ini")
...
func TestWalletManager_GetAddrBalance(t *testing.T) {
	...
	balance, err := wm.GetAddrBalance("0xbf0c58e0fe5b8837d8ccc0997d8fb71872fc0272", "pending")
	if err != nil {
...
func TestWalletManager_GetTransactionFeeEstimated(t *testing.T) {
	...
	txFee, err := wm.GetTransactionFeeEstimated(
		"0x96e9393d557071ad7a58c8c2a9db5bcbbfa3ed64",
...
func TestWalletManager_GetTransactionCount(t *testing.T) {
	wm := testNewWalletManager()
	count, err := wm.GetTransactionCount("0xbf0c58e0fe5b8837d8ccc0997d8fb71872fc0272")
	if err != nil {
